...
/**
 * A serializer for UTF-8 encoded JSON strings. org.ezstack.denormalizer.serde.JsonSerdeV3 differs from JsonSerde in that:
 * <ol>
 *   <li>
 *     It allows specifying the specific POJO type to deserialize to (using org.ezstack.denormalizer.serde.JsonSerdeV3(Class&lt;T&gt;)
 *     or org.ezstack.denormalizer.serde.JsonSerdeV3#of(Class&lt;T&gt;). JsonSerde always returns a LinkedHashMap&lt;String, Object&gt;
 ...
 * </ol>
 * This org.ezstack.denormalizer.serde.JsonSerdeV3 should be preferred over JsonSerde for High Level API applications, unless
...
public class JsonSerdeV3<T> implements Serde<T> {
    ...
    /**
     * Constructs a org.ezstack.denormalizer.serde.JsonSerdeV3 that returns a LinkedHashMap&lt;String, Object&lt; upon deserialization.
     */
    public JsonSerdeV3() {
        this(null);
    }
    ...
    /**
     * Constructs a org.ezstack.denormalizer.serde.JsonSerdeV3 that (de)serializes POJOs of class {@code clazz}.
     *
